...
export const MultiSelect = React.forwardRef<MultiSelectRef, MultiSelectProps>(
	(
		...
		const filteredOptions = React.useMemo(() => {
			...
			const filterOption = (option: MultiSelectOption) => {
				...
				return normalizedLabel.includes(normalizedSearchValue) || normalizedValue.includes(normalizedSearchValue);
			};
